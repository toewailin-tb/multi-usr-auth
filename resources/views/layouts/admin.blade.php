        ...
        <div class='quick-area'>
            ...
            <div class='pull-right'>
                <ul class="info-menu right-links list-inline list-unstyled">
                    <li class="profile">
                        <a href="#" data-toggle="dropdown" class="toggle">
                            <img src="{{ asset('data/profile/profile.png') }}" alt="user-image" class="img-circle img-inline">
                    ...
                    @can('user-list')
                        <li class="">
                            <a href="javascript:;">
                                ...
                                <span class="title">Operation Staff List</span>
                                <span class="arrow "></span><span class="label label-accent">4</span>
                            </a>
                            <ul class="sub-menu">
                                <li>
                                    <a class="" href="">Add Operation Staff</a>
                                </li>
                                <li>
                                    <a class="" href="">Operation Staff List</a>
                                </li>
                            </ul>
                        </li>
                    @endcan
                        ...
                        <li class='menusection'>Roles and Permissions</li>
                        ...
                        @can('role-list')
                            <li class="">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a class="" href="{{ route('roles.create') }}">Add Role</a>
                                    </li>
                                    <li>
                                        <a class="" href="{{ route('roles.index') }}">Role List</a>
                                    </li>
                                </ul>
                            </li>
                        @endcan
                        @can('permission-list')
                            <li class="">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a class="" href="{{ route('permissions.create') }}">Add Permission</a>
                                    </li>
                                    <li>
                                        <a class="" href="{{ route('permissions.index') }}">Permission List</a>
                                    </li>
                                </ul>
                            </li>
                        @endcan
                        <li class='menusection'>Post/2D/3D</li>
                        @can('post-list')
                            <li class="">
                                <a href="javascript:;">
